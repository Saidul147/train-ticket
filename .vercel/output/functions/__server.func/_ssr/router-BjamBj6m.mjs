...
const appCss = "/assets/styles-CS3C0Mv9.css";
const en = {
...
const LocaleContext = reactExports.createContext("en");
...
function buildLocalePath(locale, path) {
...
const SITE_ORIGIN = "https://bangladeshrailway.online";
function makeHomeHead(locale) {
...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 w-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 glass border-b border-border/40" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: buildLocalePath(locale, "/"), className: "flex items-center gap-2.5 group", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex h-9 w-9 items-center justify-center rounded-2xl bg-gradient-hero shadow-glow transition-all duration-300 group-hover:scale-110 group-hover:rotate-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-2xl shadow-inner-glow", style: { boxShadow: "var(--shadow-inner-glow)" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TramFront, { className: "relative h-4.5 w-4.5 text-primary-foreground", strokeWidth: 2.5 })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-[15px] tracking-tight", children: t("site.name") }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-medium text-muted-foreground tracking-wide uppercase mt-0.5", children: "Bangladesh Railway" })
        ] })
      ] }),
...
function SiteFooter() {
  const t = useT();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-32 border-t border-border/50 bg-card/30 backdrop-blur-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-6xl px-4 sm:px-6 py-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-2xl bg-gradient-hero shadow-glow", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TramFront, { className: "h-5 w-5 text-primary-foreground", strokeWidth: 2.5 }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-bold text-foreground", children: t("site.name") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: t("footer.copy", { year: (/* @__PURE__ */ new Date()).getFullYear() }) })
    ] })
  ] }) }) });
}
...
const Route$3 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "author", content: "BD Train Ticket" }
    ],
...
function RootComponent() {
  ...
  const locale = loc.pathname.startsWith("/bn") ? "bn" : "en";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(LocaleProvider, { locale, children: [
...
var fallback = (schema2, fallback2) => {
  return custom().pipe(schema2.catch(fallback2));
};
const $$splitComponentImporter$2 = () => import("./confirm-9ANopxh2.mjs");
const schema = objectType({
  fromcity: fallback(stringType().min(1), "").default(""),
  tocity: fallback(stringType().min(1), "").default(""),
  doj: fallback(stringType().min(1), "").default(""),
  class: fallback(enumType(TRAIN_CLASSES), "SNIGDHA").default("SNIGDHA")
});
const Route$2 = createFileRoute("/confirm")({
...
const $$splitComponentImporter$1 = () => import("./index-DKZdtwSX.mjs");
const Route$1 = createFileRoute("/")({
  head: () => makeHomeHead("en"),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./bn.index-DKZdtwSX.mjs");
const Route2 = createFileRoute("/bn/")({
  head: () => makeHomeHead("bn"),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const ConfirmRoute = Route$2.update({
  id: "/confirm",
  path: "/confirm",
...
const BnIndexRoute = Route2.update({
  id: "/bn/",
  path: "/bn/",
  getParentRoute: () => Route$3
});
